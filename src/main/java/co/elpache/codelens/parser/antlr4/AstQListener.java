...
public interface AstQListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link AstQParser#directRelation}.
     *
     * @param ctx the parse tree
     */
    void enterDirectRelation(AstQParser.DirectRelationContext ctx);

    /**
     * Exit a parse tree produced by {@link AstQParser#directRelation}.
     *
     * @param ctx the parse tree
     */
    void exitDirectRelation(AstQParser.DirectRelationContext ctx);

    /**
     * Enter a parse tree produced by {@link AstQParser#followRelation}.
     *
     * @param ctx the parse tree
     */
    void enterFollowRelation(AstQParser.FollowRelationContext ctx);

    /**
     * Exit a parse tree produced by {@link AstQParser#followRelation}.
     *
     * @param ctx the parse tree
     */
    void exitFollowRelation(AstQParser.FollowRelationContext ctx);
    ...
    /**
     * Enter a parse tree produced by {@link AstQParser#group}.
     *
     * @param ctx the parse tree
     */
    void enterGroup(AstQParser.GroupContext ctx);

    /**
     * Exit a parse tree produced by {@link AstQParser#group}.
     *
     * @param ctx the parse tree
     */
    void exitGroup(AstQParser.GroupContext ctx);
    ...
    /**
     * Enter a parse tree produced by {@link AstQParser#alias}.
     *
     * @param ctx the parse tree
     */
    void enterAlias(AstQParser.AliasContext ctx);

    /**
     * Exit a parse tree produced by {@link AstQParser#alias}.
     *
     * @param ctx the parse tree
     */
    void exitAlias(AstQParser.AliasContext ctx);
